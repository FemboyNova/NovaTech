...
import { Github, MapPin, Code2, ExternalLink, Mail, Clock } from 'lucide-react'
...
// Pre-generate star positions with seeded random
const generateStars = () => 
  [...Array(50)].map((_, i) => ({
    id: i,
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        {/* Floating Stars - only render client-side to avoid hydration mismatch */}
        {mounted && (
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-8 pt-24 md:px-8 md:py-16 md:pt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-[minmax(120px,auto)]">
          ...
          <div 
            className={`md:col-span-2 lg:col-span-2 row-span-2 group transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div className="flex items-center gap-6 mt-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-zinc-500">{dayText}</span>
                    <div className="flex">
                      {timeDigits.map((digit) => (
                        <span 
                          key={digit.key} 
                          className="text-sm font-mono font-semibold text-zinc-300 tabular-nums inline-block"
                          style={{
          ...
          <a
            ...
            className={`group relative p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/10 overflow-hidden transition-all duration-300 hover:border-[#8534F3]/50 hover:scale-[1.02] hover:shadow-xl hover:shadow-[#8534F3]/10 active:scale-[0.98] ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            style={{ transitionDelay: '100ms', transitionDuration: '400ms' }}
          >
            <div className="absolute inset-0 bg-gradient-to-br from-[#8534F3]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            <div className="relative z-10 h-full flex flex-col justify-between">
              <Github className="w-8 h-8 text-zinc-400 group-hover:text-[#8534F3] group-hover:scale-110 group-hover:-rotate-12 transition-all duration-300" />
              <p className="text-lg font-semibold text-white group-hover:translate-x-1 transition-transform duration-300">FemboyNova</p>
            </div>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`group relative p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/10 overflow-hidden transition-all duration-300 hover:border-zinc-400/50 hover:scale-[1.02] hover:shadow-xl hover:shadow-zinc-400/10 active:scale-[0.98] ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`group relative p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/10 overflow-hidden transition-all duration-300 hover:border-[#5865F2]/50 hover:scale-[1.02] hover:shadow-xl hover:shadow-[#5865F2]/10 active:scale-[0.98] ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          ...
          <a
            ...
            className={`group relative p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/10 overflow-hidden transition-all duration-300 hover:border-pink-500/50 hover:scale-[1.02] hover:shadow-xl hover:shadow-pink-500/10 active:scale-[0.98] ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            style={{ transitionDelay: '250ms', transitionDuration: '400ms' }}
          >
          ...
          <div 
            className={`md:col-span-2 lg:col-span-2 group transition-all duration-400 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            style={{ transitionDelay: '300ms' }}
          >
            <div className="relative h-full p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/10 overflow-hidden transition-all duration-300 hover:border-violet-500/50 hover:scale-[1.02] hover:shadow-xl hover:shadow-violet-500/10">
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-3">
                  {/* JavaScript */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-yellow-500/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-300 cursor-default group/tech">
                    <svg className="w-5 h-5 text-zinc-400 group-hover/tech:text-yellow-400 transition-colors duration-200" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {/* TypeScript */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-blue-500/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-300 cursor-default group/tech">
                  ...
                  {/* React */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-cyan-500/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-300 cursor-default group/tech">
                  ...
                  {/* Next.js */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-300 cursor-default group/tech">
                  ...
                  {/* Tailwind CSS */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-teal-500/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-300 cursor-default group/tech">
                  ...
                  {/* Node.js */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-green-500/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-300 cursor-default group/tech">
          ...
          >
            <div className="relative h-full p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/10 overflow-hidden transition-all duration-300 hover:border-cyan-500/50 hover:scale-[1.02] hover:shadow-xl hover:shadow-cyan-500/10">
              ...
              <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-violet-400/20 to-transparent rounded-full blur-2xl" />
