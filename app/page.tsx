            ...
            <div className="relative h-full p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/10 overflow-hidden transition-all duration-300 hover:border-violet-500/30">
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-3">
                  {/* JavaScript */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-yellow-500/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-200 cursor-default group/tech">
                  ...
                  {/* TypeScript */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-blue-500/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-200 cursor-default group/tech">
                  ...
                  {/* React */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-cyan-500/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-200 cursor-default group/tech">
                  ...
                  {/* Next.js */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-200 cursor-default group/tech">
                  ...
                  {/* Tailwind CSS */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-teal-500/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-200 cursor-default group/tech">
                  ...
                  {/* Node.js */}
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-green-500/30 hover:scale-105 hover:-translate-y-0.5 transition-all duration-200 cursor-default group/tech">
